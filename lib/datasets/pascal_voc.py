...
class pascal_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        :param image_set: trainval
        :param year: 2007
        :param devkit_path: None
        '''
        ...
        #self._devkit_path=data / VCOdevkit2007
        self._data_path = os.path.join(self._devkit_path, 'VOC' + self._year)
        #self._data_path = data/VCOdevkit2007/VOC2007
        ...
        #self._class_to_ind={'__background__': 0, 'aeroplane': 1,.....}
        self._image_ext = '.jpg'
        self._image_index = self._load_image_set_index()
        ##image_index = [000005,000007,000009,....]训练图片的索引，共5011张图片
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join(self._data_path, 'ImageSets', 'Main',
                                      self._image_set + '.txt')
        #self._data_path = data/VCOdevkit2007/VOC2007     self._image_set =trainval
        #image_set_file=data/VCOdevkit2007/VOC2007/ImageSets/Main/trainval.txt
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'VOCdevkit' + self._year) #cfg.DATA_DIR=data
    #retrun data/VCOdevkit2007
    ...
    def _load_pascal_annotation(self, index):
        ...
        format.
        """
        filename = os.path.join(self._data_path, 'Annotations', index + '.xml')#filename=../../00026.xml
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_voc_results_file(all_boxes)#将每个类的检测结果写入txt文件
